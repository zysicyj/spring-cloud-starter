...
import com.huan.common.exception.CheckLastTimeException;
import com.huan.common.util.leaf.common.PropertyFactory;
...
public class SnowflakeZookeeperHolder {
    ...
    SnowflakeZookeeperHolder(String ip, String port, String connectionString) {
        this.ip = ip;
        this.port = port;
    ...
    private void ScheduledUploadData(CuratorFramework curator, String zk_AddressNode) {
